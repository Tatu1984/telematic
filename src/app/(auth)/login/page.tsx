        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 mb-3 text-center">
              Demo Credentials (Password: FleetTrack2024!)
            </p>
            <div className="space-y-2 text-xs">
              <div className="flex justify-between items-center py-1 border-b border-gray-200 dark:border-gray-700">
                ...
                <span className="font-mono text-gray-700 dark:text-gray-300">admin@fleettrack.com</span>
              </div>
              <div className="flex justify-between items-center py-1 border-b border-gray-200 dark:border-gray-700">
                <span className="text-gray-500 dark:text-gray-400">Company Admin:</span>
                <span className="font-mono text-gray-700 dark:text-gray-300">admin@acmetrucking.com</span>
              </div>
              <div className="flex justify-between items-center py-1 border-b border-gray-200 dark:border-gray-700">
                <span className="text-gray-500 dark:text-gray-400">Fleet Manager:</span>
                <span className="font-mono text-gray-700 dark:text-gray-300">fleet@acmetrucking.com</span>
              </div>
              <div className="flex justify-between items-center py-1">
                <span className="text-gray-500 dark:text-gray-400">Driver:</span>
                <span className="font-mono text-gray-700 dark:text-gray-300">driver@acmetrucking.com</span>
              </div>
            </div>
          </div>
        </CardContent>
